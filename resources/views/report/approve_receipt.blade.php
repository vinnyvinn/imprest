...
<div class="content">
    ...
    <section class="info">
        ...
        <div style="padding: 5px; text-transform: uppercase;">
            <div style="width: 40%; display: inline-block;">Personal Number: <strong>{{ isset($imprest->ucGLHRNO)?:" " }}</strong></div>
...
{{--                <td style="border: 1px solid #999999; text-align: center">{{ $imprest->CB_number }}</td>--}}
 ...
 <section>
        <br>
        <br>
        @if(Auth::user()->role_id == 3 or Auth::user()->role_id == 0)

            @if($imprest->officer)
            <p>
            1. (i) This is a system generated imprest and has being approved 
           			by :-
               <div style="width: 80%; margin: 0 auto;">
                <div style="width: 50%; float: left;">
                    <div style="text-align: center; margin: 0 10px" class="dotted"></div>
                    <div>HOD -> {{$imprest->name}}  Department  </div>
                </div>
                <div style="width: 50%; float: right;">
                    <div style="text-align: center; margin: 0 30px" class="dotted"></div>
                    <div style="text-align: center;">Officer Name :: {{$imprest->officer->name}}</div>
                </div>
            </div>
